...
export const journeyAboutLeadHtml = `The sections below organise examples into forest walks and nature trails, day and multi-day hikes, and cycle routes.
          Each slide links to a public route or place resource where one is listed, and to a suggested PurePod booking link for a nearby site.
...
export const journeyForestSlides: ForestSlide[] = [
  ...
  },
  {
    ...
    ctaHref: "https://purepods.com/booking/?force_site_id=15",
  },
  {
    ...
    ctaHref: "https://purepods.com/booking/?force_site_id=7",
  },
  {
    ...
    ctaHref: "https://purepods.com/booking/?force_site_id=3",
  },
];
...
export const journeyHikingSlides: HikingSlide[] = [
  {
    ...
    ctas: [{ label: "Stay at Matū, Waitomo →", href: "https://purepods.com/booking/?force_site_id=16" }],
  },
  {
    ...
    ctas: [{ label: "Stay at Kokomea, Kapiti Coast →", href: "https://purepods.com/booking/?force_site_id=10" }],
  },
  {
...
export const journeyFaq: { q: string; a: string }[] = [
  {
    ...
    a: "Journey is a PurePods experience page that groups walking, hiking and cycling ideas with suggested PurePod stays. It presents example forest walks, hikes and cycle routes in selected New Zealand regions, with external links to route information and internal booking links to nearby pods.",
  },
  {
  ...
  },
  {
    ...
    a: "Use the main Book control in the navigation, the “Find your PurePod” call to action, or each section’s “Stay at [pod name]” link. Those booking links open the PurePods booking flow, often with a suggested site pre-selected where shown.",
  },
];
