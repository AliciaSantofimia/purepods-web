export const romanticFaq = [
  {
    q: "What makes a PurePods romantic getaway different?",
    a: "A PurePods romantic stay combines complete privacy, remote New Zealand landscapes and uninterrupted time together. The experience is designed for calm, connection and memorable moments in nature.",
  },
  {
    q: "Is PurePods suitable for proposals, anniversaries or special occasions?",
    a: "Yes. Many guests choose PurePods for proposals, anniversaries, birthdays and meaningful celebrations. The setting is quiet, private and naturally suited to intimate moments.",
  },
  {
    q: "Can we book a PurePods stay even without a special occasion?",
    a: "Absolutely. Many romantic stays are simply about stepping away from routine, slowing down together and enjoying time in nature without distractions.",
  },
];
...
export const romanticGallery = [
  ...
  },
  {
    ...
    alt: "Stargazing from a PurePods glass cabin bed under the night sky in New Zealand",
  },
];
