...
export default function HananuiPage() {
  return (
    <>
        ...
        <Container as="div" className={styles.locationContent}>
          <PodSection
            ...
            gallery={[
              ...
              {
                src: podExterior,
                alt: "Hananui PurePod exterior with native forest and ocean views above Lee Bay, Stewart Island, New Zealand",
                position: "50% 50%",
                fillGap: true,
              },
              {
                src: podKiwi,
                alt: "Kiwi in the wild, Stewart Island, New Zealand",
                position: "50% 50%",
              },
            ]}
