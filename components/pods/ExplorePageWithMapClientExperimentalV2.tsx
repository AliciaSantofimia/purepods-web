...
import { ExploreNzMapPanelExperimentalV2 } from "@/components/pods/ExploreNzMapPanelExperimentalV2";
...
export function ExplorePageWithMapClientExperimentalV2({ pods }: { pods: ExplorePodCard[] }) {
      ...
      <section className={styles.section}>
        ...
        >
          <aside className={xstyles.splitMap} aria-label="Map of pod locations">
            <ExploreNzMapPanelExperimentalV2
              pods={mapPods.map((p) => ({
                slug: p.slug,
                title: p.title,
                pill: p.pill,
