This file defines the official PurePods pod names and locations.

These names must never be modified, translated, or invented when generating website content or code.
